...
- converting Objective-C-heavy dynamic frameworks to static without duplicate-symbol and duplicate-class checks
...
- [ ] Are Objective-C class/category duplication risks checked?
...
Classify relevant dependencies by ownership, linkage, packaging, and launch relevance.
...
Call out resources, extensions, duplicate symbols, Objective-C classes/categories, vendor constraints, symbolication, and build-time risks.
